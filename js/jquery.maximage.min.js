    ...
    this.each(function () {
        ...
        setup: function () {
          ...
          if (a.Slides.length > 0) {
            ...
            for (r = 0; r < p; r++) {
              ...
              q = a("<div>" + u + "</div>").attr(
                "class",
                "mc-image mc-image-n" + r + " " + a.Slides[r].theclass
              );
              m.append(q);
              ...
              .each(function (r) {
                ...
                if (q.hasClass("not-loaded")) {
                  if (q.height() > 0) {
                    ...
                    var s = a("div.mc-image-n" + r)
                      .children("img")
                      .first();
                    s.data("h", q.height())
                      .data("w", q.width())
                      .data("ar", q.width() / q.height());
                    h.onceLoaded(r);
                  }
                }
              });
          ...
          var r = a.extend(
            {
              ...
              slideResize: false,
              easing:
                a.BrowserTests.cssTransitions && c.cssTransitions
          ...
          if (typeof c.backgroundSize == "function") {
            ...
            if (c.backgroundSize == "cover") {
              if (a.Window.data("w") / a.Window.data("h") < q.data("ar")) {
                p.height(a.Window.data("h")).width(
                  (a.Window.data("h") * q.data("ar")).toFixed(0)
                );
              } else {
                p.height((a.Window.data("w") / q.data("ar")).toFixed(0)).width(
                  a.Window.data("w")
                );
              }
            } else {
              if (c.backgroundSize == "contain") {
                if (a.Window.data("w") / a.Window.data("h") < q.data("ar")) {
                  p.height(
                    (a.Window.data("w") / q.data("ar")).toFixed(0)
                  ).width(a.Window.data("w"));
                } else {
                  p.height(a.Window.data("h")).width(
                    (a.Window.data("h") * q.data("ar")).toFixed(0)
      ...
      var k = {
        browser_tests: function () {
          var q = a("<div />")[0],
            ...
            s = {
              ...
              cssBackgroundSize:
                "backgroundSize" in q.style && c.cssBackgroundSize,
              html5Video: false,
              msie: false,
            };
          if (c.cssTransitions) {
        ...
        construct_slide_object: function () {
          ...
          m.children().each(function (t) {
            ...
            r.orig = s.clone();
            r.datahref =
              s.attr("data-href") != undefined ? s.attr("data-href") : "";
            r.content = "";
        ...
        msie: function () {
          ...
          while (
            ((s.innerHTML = "<!--[if gt IE " + ++p + "]><i></i><![endif]-->"),
            q[0])
          ) {}
          return p > 4 ? p : r;
        },
      ...
      if (typeof d == "string") {
        if (a.BrowserTests.html5Video || !m.is("video")) {
          var l,
            o = m.is("object") ? m.parent().first() : m;
